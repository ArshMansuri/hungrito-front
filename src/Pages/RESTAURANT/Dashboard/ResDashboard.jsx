          ...
          <div className="das-pie-and-order-chart">
            <div className="row">
              <div className="col-xl-6 col-12 d-flex justify-content-center mt-3">
                <div className="dash-pie-chart px-4 py-2">
                  ...
                  <div className="row h-100 py-3">
                    ...
                    <div className="col-4">
                      <ResPieChart title="Customer Growth" value={[22,78]} bg={["#00B074", "rgba(0, 176, 116, 0.15)"]} />
                    </div>
                    <div className="col-4">
                      <ResPieChart title="Total Revenue" value={[62,38]} bg={["#2D9CDB", "rgba(45, 156, 219, 0.15)"]} />
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-xl-6 col-12 d-flex justify-content-center mt-3">
                ...
                <ResAreaChart value={[100, 150, 350, 200, 60, 230, 120, 200, 350, 400, 300, 250]} borCol={"rgb(53, 162, 235)"} bg={"rgba(53, 162, 235, 0.5)"} />
                </div>
                </div>
              </div>
            </div>
