  ...
  return (
    <div className="db-order-page">
      ...
      <div className="db-order-tow-part">
        <div className="row">
            <div className={`col-6 py-3 d-flex justify-content-center ${activeScree === "newOrder" ? "active-screen" : "inactive-screen" }`} onClick={()=>setActiveScreen("newOrder")}>
                <span>New Order</span>
            </div>
            <div className={`col-6 py-3 d-flex justify-content-center ${activeScree === "activeOrder" ? "active-screen" : "inactive-screen" }`} onClick={()=>setActiveScreen("activeOrder")}>
      ...
      <div>
        {
            ...
            <DbNewOrderPage /> : <DbActiveOrderPage />
        }
      </div>
    </div>
  );
